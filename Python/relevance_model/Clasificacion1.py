...
# funcion para limpiar el contenido del source
...
def crear_modelo(df0):
    ...
    x_train, x_test, y_train, y_test = train_test_split(df_x, df_y, test_size=0.3, random_state=45)
    ...
    roc_auc_score(y_test, text_clf.predict_proba(x_test)[:,1])
    
    # Salvando o modelo

    arquivo = 'c:\mbit\proyecto\modelo_clf.sav'
...
if __name__ == '__main__':
    try:
        ...
        procesando = procesando_modelo('c:\mbit\proyecto\modelo_clf.sav',data_set)
