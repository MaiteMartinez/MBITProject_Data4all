...
ui <- fluidPage(theme = "bootstrap.css",
                ...
                tags$style(HTML(" .tabbable > .nav > li > a[data-value='Listado de candidatos']  {background-color: #0E6251;  color:white}
                                .tabbable > .nav > li > a[data-value='Grafo']     {background-color: #F8C471  ;   color:black}" 
                                )),
                
                tabsetPanel(
                  
                  tabPanel("Listado de candidatos",  value = "Listado de candidatos", 
                  ...
                  tabPanel("Grafo", value = "Grafo", 
                           br(),
                           ("Introduce la busqueda por User_id para localizar al candidato en el grafo"),
                           browsable(
                             attachDependencies(
                               tagList(
                                 tags$head(
  ...
  output$mytable1 <- DT::renderDataTable({
    ...
    DT::datatable(add_to_MisNodos(), 
                  ...
                  colnames = c(HTML('<span title ="">N</span>') , 
                               ...
                               HTML('<span title ="Tiene en cuenta la relacion directa e indirecta de un nodo con el resto
                                    de nodos de la red penalizandolos a medida que crece la distacia.">Katz_bonacich</span>'),
                               ...
                               HTML('<span title ="PonderacioÂ³n de todos los Indices">Resultado</span>')
                               ),
