...
% From 24128 tweets analized, we've found 365 relevant ones, that represent a 1.51% of total
% We had 365 relevant tweets, and from those we extract 231 relevant users whose data ['user_id', 'url', 'user_name', 'user_bio'] is not duplicated 
% From 231 users analized, we've found 161 classified as persons, that represent a 69.7% of total
% From 161 classified as persons, there are 161 unique user_id, that is, there were 0users with different user name, url or description in the downloaded data
