...
Aceptamos estos primeros resultados y decidimos empezar el proyecto con este modelo para hacer las pruebas hasta el final del proyecto. Sin embargo, estamos seguros de que es posible mejorarlo, principalmente en la precisión de los aciertos en la clase positivas ($TP$) y en la curva ROC. Hemos empezado a hacer pruebas con otros algoritmos y métodos de optimización (ver sección \ref{sect:mejoras_alg_clasificacion_tuit}).
...
relevante, lo que representa un $1.51$\% del total. 
